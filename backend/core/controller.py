...
class Controller:
    ...
    def process_prompt(self, prompt: str):
        ...
        try:
            ...
            self.queue.add_task(self.visual_generator.generate_visuals, scenes)
            self.queue.add_task(self.voice_generator.generate_voice, scenes)
            self.queue.add_task(self.image_generator.generate_images, scenes)
